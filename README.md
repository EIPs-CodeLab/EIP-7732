...
*For a detailed explanation of how ePBS works, the design decisions behind each component, and how this implementation maps to the spec, see [Medium]([docs/TECHNICAL.md](https://medium.com/@zakariasaif/ethereum-just-fired-its-middleman-273993cee519)).*
